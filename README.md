...
- The weighted average is the sum of the temperatures from each city multiplied by their population then divided by the total population (IMPORTANT: totalPop is only taken from the cities we actually use)
